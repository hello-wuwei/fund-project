  ...
  <div class="right-block">
    <el-form class="form-list" label-width="140px" label-position="right" style="margin-left: 100px; width: 700px;margin-top: 30px">
      ...
      <el-form-item class="done-list" label="风险揭示书上传：">
        <el-button type="primary" class="btn-dashed" style="width: 238px">+ 风险揭示书上传</el-button><i class="el-icon-success"></i>
      </el-form-item>
      <el-form-item class="done-list" label="录入信息：">
        <el-button type="primary" style="width: 238px" @click="enterInfo">录入信息</el-button><i class="el-icon-success"></i>
      </el-form-item>
    ...
    <div class="foot-done" style="text-align: center;margin-top: 40px" type="primary">
      <el-button @click="$emit('removeTag', 'riskbookDone')">返 回</el-button>
    </div>
