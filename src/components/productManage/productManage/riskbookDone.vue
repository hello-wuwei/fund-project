...
<template lang="html">
  <div class="page">
    <com-breadcrumb :list="['产品创设', '风险揭示书处理']"></com-breadcrumb>
      ...
      <div class="border-line">
        <el-form class="form-list" label-width="140px" label-position="right" style="width: 700px">
          <el-form-item label="风险揭示书：">
            ...
            <el-button style="margin-left: 60px" size="mini" type="primary" @click="util.loadFileByUrl(productInfo.revealBookUrl.url)">下 载</el-button>
          </el-form-item>
          ...
          <el-form-item class="done-list" label="打标签：">
            <el-button type="primary" class="btn-dashed" style="width: 238px" @click="makingLabel" :disabled="productInfo.revealBookState==3">+ 打标签</el-button>
...
//        window.open(this.productInfo.contractUrl.url)
      ...
      makingLabel () {
        ...
        this.$router.push({path: '/home/product/risksign', query: {bookId: this.propValue.bookId}})
      },
      ...
      enterInfo () {
        ...
        this.$router.push({path: '/home/product/enterinfo', query: {bookId: this.propValue.bookId}})
      }
    }
  }
</script>
