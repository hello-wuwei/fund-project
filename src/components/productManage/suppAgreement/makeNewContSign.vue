<template>
  <div class="page">
    <com-breadcrumb :list="['补充协议', '新合同处理', '打标签']"></com-breadcrumb>
          ...
          <div style="min-width: 1260px;overflow: hidden">
            ...
            <div class="contract-con">
              ...
              <div class="pdf-box" style="position:relative;width: 892.5px;height:1261.5px;">
                <pdf-view :src="productInfo.contractUrl.url" :page="page" @numPages="numPages = $event">
    ...
    <el-dialog title="提 示" :visible.sync="sureBack" style="margin:auto;width: 700px">
      <div style="text-align: center">您是否确认打标签设置完成？确认后新合同将发送至管理人。</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getViewLabel () {
        viewSignFile(1, this.productInfo.productId, this.propValue.contractId, this.labelData, this)
      },
      ...
      async getProInfo () {
        ...
        switch (res.code) {
          case 0:
            ...
            this.productInfo.contractUrl = JSON.parse(res.data.bean.contractUrl)
            let labelContent = await getLabelViewData(this.productInfo.productId, this.productInfo.contractId, 0, 1, this)
...
//        }
      ...
      async subLabel () {
        ...
        let obj = {
          ...
          filePdfUrl: this.productInfo.contractUrl,
