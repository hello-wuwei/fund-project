...
<template lang="html">
  <div class="page">
    <com-breadcrumb :list="['补充协议', '查看']"></com-breadcrumb>
      ...
      <div class="border-line">
        ...
        <el-form class="form-list" label-width="240px" style="width: 700px">
          ...
          <el-form-item label="补充协议状态：">
            {{{0:'待上传合同',1:'待打标签',2:'已打标签'}[productInfo.suppleContractElecState]}}
          </el-form-item>
        </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getMainFileName (code) {
        return {1: '基金合同', 3: '补充协议', 4: '公告告知', 5: '征询意见函'}[code]
      },
          ...
          case 0:
            ...
            if (res.data.bean.originalSuppleContractUrl !== '{}') {
              this.productFileList.push({
                fileName: this.getMainFileName(res.data.bean.contractType),
