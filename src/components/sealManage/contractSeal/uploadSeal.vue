...
<template lang="html">
  <div class="page">
    <com-breadcrumb :list="['管理人合同章管理', '上传']"></com-breadcrumb>
    <div class="right-block">
      <h4>请上传托管人印章图片用于公司电子印章的制作</h4>
      <div class="user-info">
...
<script>
  ...
  export default {
    ...
    methods: {
      async getSealInfo () {
        let res = await this.$sever.getSealInfo({userId: this.userId, sealTypeStr: 'SEAL_CONTACT', sysCode: 'TTD_MANAGE_SYSTEM'})
        switch (res.code) {
          case 0:
