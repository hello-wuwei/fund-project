...
<script>
  import custodianSealList from './custodianSeal/custodianSealList.vue'
  import uploadSeal from './custodianSeal/uploadSeal.vue'
  export default {
    components: {
      custodianSealList,
      uploadSeal
    ...
    data () {
      return {
        // tab组件切换
        comNameConfig: 'custodianSealList',         // 菜单主页面组件名称（固定值/常量）
        activeTag: 'custodianSealList',
        editableTabs: [{
          title: '托管人印章管理',
          name: 'custodianSealList'
        }],
