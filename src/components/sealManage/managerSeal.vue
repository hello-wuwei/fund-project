...
<script>
  import managerSealList from './managerSeal/managerSealList.vue'
  import uploadSeal from './managerSeal/uploadSeal.vue'
  export default {
    components: {
      managerSealList,
      uploadSeal
    ...
    data () {
      return {
        // tab组件切换
        comNameConfig: 'managerSealList',         // 菜单主页面组件名称（固定值/常量）
        activeTag: 'managerSealList',
        editableTabs: [{
          title: '管理人印章管理',
          name: 'managerSealList'
        }],
