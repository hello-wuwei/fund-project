<template lang="html">
  <div class="page">
    <com-breadcrumb :list="['管理人法人章管理']"></com-breadcrumb>
    <div class="content-main">
      ...
      <el-table header-row-class-name="table-header-define" class="table-btn-style" :data="tableData" highlight-current-row style="width: 100%">
        ...
        <el-table-column label="操作" align="center">
          <template v-if="SEAL_MANAER_UPLOAD" slot-scope="scope">
...
<script>
  export default {
    ...
    methods: {
      ...
      editSeal (userId) {
        this.$router.push({path: '/home/managerSealCorp/upload', query: {userId: userId}})
      },
      uploadSeal (userId) {
        this.$router.push({path: '/home/managerSealCorp/upload', query: {userId: userId}})
      },
