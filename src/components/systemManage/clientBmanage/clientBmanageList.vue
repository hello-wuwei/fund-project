<template>
  <div class="page">
    <com-breadcrumb :list="['B端管理']"></com-breadcrumb>
    <div class="content-main tree-text">
      ...
      <div style="margin-top: 15px">
        <el-button v-if="SYS_B_NEW" class="bom-btn" size="mini" icon="el-icon-plus" @click="addResouce">新增资源</el-button>
      </div>
    </div>
  </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      addResouce () {
        this.$router.push({path: '/home/clientBmanage/addResouce'})
      },
      editResouce (sourcesId) {
        this.$router.push({path: '/home/clientBmanage/editResouce', query: {sourcesId: sourcesId}})
      },
