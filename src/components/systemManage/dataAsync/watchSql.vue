<template>
  <div class="page">
    <com-breadcrumb :list="['SQL同步', '查看SQL']"></com-breadcrumb>
      ...
      <div class="border-line">
        <el-form :model="submitData" :rules="rules" ref="ruleForm" class="form-size" label-width="120px">
          <el-form-item label="服务名称：" style="width: 360px" prop="dataKey">
            <el-input v-model="submitData.dataKey" placeholder="请输入" size="small" disabled></el-input>
          </el-form-item>
          <el-form-item label="SQL标识：" style="width: 360px" prop="sqlCode">
            <el-input v-model="submitData.sqlCode" placeholder="请输入" size="small" disabled></el-input>
          </el-form-item>
          <el-form-item label="SQL类型：" style="width: 360px" prop="operationType">
            <el-select v-model="submitData.operationType" placeholder="请输入" size="small" disabled>
          ...
          <el-form-item label="是否参数可变：" style="width: 360px">
            <el-radio v-model="submitData.isParamAgile" label="1" disabled>是</el-radio>
            <el-radio v-model="submitData.isParamAgile" label="0" disabled>否</el-radio>
          </el-form-item>
          <el-form-item label="SQL语句描述：" style="width: 500px" prop="sqlRemark">
            <el-input v-model="submitData.sqlRemark" type="textarea" :rows="4" placeholder="请输入" disabled></el-input>
          </el-form-item>
          <el-form-item label="分页语句：" style="width: 500px" prop="pageSql">
            <el-input v-model="submitData.pageSql" type="textarea" :rows="4" placeholder="请输入" disabled></el-input>
          </el-form-item>
          <el-form-item label="排序语句：" style="width: 500px" prop="orderSql">
            <el-input v-model="submitData.orderSql" type="textarea" :rows="4" placeholder="请输入" disabled></el-input>
          </el-form-item>
          <el-form-item label="SQL语句：" style="width: 500px" prop="sqlInfo">
            <el-input v-model="submitData.sqlInfo" type="textarea" :rows="4" placeholder="请输入" disabled></el-input>
          </el-form-item>
        </el-form>
      </div>
