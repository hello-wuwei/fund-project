...
<script>
  import manageBackstageList from './manageBackstage/manageBackstageList.vue'
  import addResouce from './manageBackstage/addResouce.vue'
  import editResouce from './manageBackstage/editResouce.vue'
  import seeResouce from './manageBackstage/seeResouce.vue'
  export default {
    components: {
      manageBackstageList,
      addResouce,
    ...
    data () {
      return {
        // tab组件切换
        comNameConfig: 'manageBackstageList',         // 菜单主页面组件名称（固定值/常量）
        activeTag: 'manageBackstageList',
        editableTabs: [{
          title: '管理后台',
          name: 'manageBackstageList'
        }],
