    ...
    <div class="content-main">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="关键词">
          <el-input v-model="formData.keyword" placeholder="请输入账号、姓名或操作模块" size="small"></el-input>
        </el-form-item>
      ...
      <el-table header-row-class-name="table-header-define" :data="tableData" highlight-current-row style="width: 100%">
        ...
        <el-table-column property="moduleName" label="模块名称" align="center" width="100"></el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="watchLog(scope.row)">查 看</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    data () {
      return {
        currentPage: 1,
        formData: {
//          applCode: 'TTD_MANAGE_SYSTEM',
//          companyId: '',
          keyword: '',
//          operationUserType: 'BACKUSER',
          createdStart: '',
          createdEnd: '',
          isAll: 1,
          pageNum: 1
...
//      this.formData.companyId = this.util.getStorage('TTD_MANAGE_USERINFO').userId
    ...
    methods: {
      ...
      watchLog (row) {
        this.$emit('addTag', {title: '日志查看', name: 'watchLog', row: row})
      },
