    ...
    <div class="content-main">
      <el-form :rules="rules" ref="formData" :model="formData" class="form-size" label-width="160px">
        ...
        <!--<el-form-item label="组织ID：" prop="deptId">-->
          <!--<el-input v-model="formData.deptId" placeholder="请输入资源编码" size="small" style="width: 400px"></el-input>-->
        <!--</el-form-item>-->
      ...
      <div class="foot-btn">
        ...
        <el-button @click="$emit('removeTag', 'addResouce')">返 回</el-button>
      </div>
    </div>
      ...
      async newResouce () {
        ...
        switch (res.code) {
          case 0:
            ...
            this.$emit('removeTag', 'addResouce')
            break
          default:
