...
<script>
  import userRoleList from './roleManage/userRoleList.vue'
  import addRole from './roleManage/addRole.vue'
  import editRole from './roleManage/editRole.vue'
  import seeRole from './roleManage/seeRole.vue'
  export default {
    components: {
      userRoleList,
      addRole,
