...
<script>
  import systemAccountList from './systemAccount/systemAccountList.vue'
  import addAccount from './systemAccount/addAccount.vue'
  import editAccount from './systemAccount/editAccount.vue'
  export default {
    components: {
      systemAccountList,
      addAccount,
    ...
    data () {
      return {
        // tab组件切换
        comNameConfig: 'systemAccountList',         // 菜单主页面组件名称（固定值/常量）
        activeTag: 'systemAccountList',
        editableTabs: [{
          title: '系统账号',
