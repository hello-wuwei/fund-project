    ...
    <div class="user-info">
      ...
      <el-form :model="formData" ref="subForm" :rules="subFormRules" label-width="120px" label-position="left">
        ...
        <el-form-item label="验证码：" prop="oldCode">
          <el-input v-model.number="formData.oldCode" placeholder="请输入动态密码" size="small" style="width: 260px;margin-right: 10px"></el-input>
        </el-form-item>
        ...
        <el-form-item label="验证码：" prop="newCode">
          <el-input v-model.number="formData.newCode" placeholder="请输入动态密码" size="small" style="width: 260px;margin-right: 10px"></el-input>
        </el-form-item>
      </el-form>
    </div>
