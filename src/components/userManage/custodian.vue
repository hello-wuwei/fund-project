...
<script>
  import custodianList from './custodian/custodianList.vue'
  import addAccount from './custodian/addAccount.vue'
  import editAccount from './custodian/editAccount.vue'
  import addOrgInfo from './custodian/addOrgInfo.vue'
  export default {
    components: {
      custodianList,
      addAccount,
    ...
    data () {
      return {
        // tab组件切换
        comNameConfig: 'custodianList',         // 菜单主页面组件名称（固定值/常量）
        activeTag: 'custodianList',
        editableTabs: [{
          title: '托管人管理',
          name: 'custodianList'
        }],
