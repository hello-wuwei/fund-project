  ...
  <div class="page">
    ...
    <div class="content-main">
      ...
      <el-table header-row-class-name="table-header-define" :data="tableData" highlight-current-row style="width: 100%">
        ...
        <el-table-column property="roleInfo" label="所属角色" align="center"></el-table-column>
        ...
        <el-table-column label="操作" align="center" width="400">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="getRole_user(scope.row.userId)">授 权</el-button>
            <el-button size="mini" type="primary" @click="editAccount(scope.row.userId)">修 改</el-button>
            <el-button size="mini" @click="disabledUse(scope.row.userId, scope.row.state)">{{scope.row.state==3?'停 用':'启 用'}}</el-button>
            <el-button size="mini" @click="addOrgInfo(scope.row.userId)">编辑托管人机构信息</el-button>
          </template>
        </el-table-column>
      </el-table>
