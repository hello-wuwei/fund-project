...
<script>
  ...
  import managerWatch from './manager/managerWatch.vue'
  import orgManagerCheck from './manager/orgManagerCheck.vue'
  import accManagerCheck from './manager/accManagerCheck.vue'
  export default {
    components: {
      managerList,
      managerWatch,
    ...
    data () {
      return {
        // tab组件切换
        comNameConfig: 'managerList',         // 菜单主页面组件名称（固定值/常量）
        activeTag: 'managerList',
        editableTabs: [{
          title: '管理人管理',
          name: 'managerList'
        }],
