...
<script>
  import orgInverstorList from './orgInverstor/orgInverstorList.vue'
  import orgCheck from './orgInverstor/orgCheck.vue'
  export default {
    components: {
      orgInverstorList,
      orgCheck
    ...
    data () {
      return {
        // tab组件切换
        comNameConfig: 'orgInverstorList',         // 菜单主页面组件名称（固定值/常量）
        activeTag: 'orgInverstorList',
        editableTabs: [{
          title: '机构投资者',
          name: 'orgInverstorList'
        }],
